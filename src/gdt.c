...
void register_gdt(void)
{
    ...
    set_entry(KERNEL_STACK_I, 0, 0xFFFFFFFF, DESCRIPTOR | PRESENT | PRIVILEGE_0 | READ_WRITE, 0xCF);
    ...
    set_entry(USER_STACK_I, 0, 0xFFFFFFFF, DESCRIPTOR | PRESENT | PRIVILEGE_3 | READ_WRITE, 0xCF);
