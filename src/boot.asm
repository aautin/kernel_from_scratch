...
section .multiboot
	...
	MULTIBOOT_INFO_MEMORY_FLG  equ 0x00000001
	MULTIBOOT_INFO_MEM_MAP_FLG equ 0x00000040
	MULTIBOOT_MAGIC            equ 0x1BADB002
	MULTIBOOT_FLAGS            equ ( MULTIBOOT_INFO_MEMORY_FLG | MULTIBOOT_INFO_MEM_MAP_FLG )
